...
% just like ginputc, but the right mouse click is marked in a different
% color
            ...
            case {8, 127}   % delete or backspace
                if ~isempty(x)
                    ...
                    if showpoints
                        ...
                        set(delPoints, ...
                            'XData', deletedPoints(:, 1), ...
                            'YData', deletedPoints(:, 2));
                    end
...
%--------------------------------------------------------------------------
    function updatePoints(clickType)
        ...
        if showpoints
            ...
            if ( clickType == 3)
                deletedPoints = [deletedPoints; cursorPt([1 3])];
                set(delPoints, ...
                    'XData', deletedPoints(:, 1), ...
                    'YData', deletedPoints(:, 2));
            end
